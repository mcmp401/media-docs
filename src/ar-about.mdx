...
:::tip
`https://gateway.arweave.network` is a hosted Arweave gateways maintained by The Media Foundation and served using Media Network's community-powered CDN) [view an example →](https://gateway.arweave.network/m4up8Ekc3fmNYr6zoxLB846C9DnuuRW4sE7hHsGnclk)
:::
