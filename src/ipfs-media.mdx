...
- Make sure you have ipfs [installed](ipfs-setup).
- Make sure your gateway is [accessible](ipfs-config#accessing-your-http-gateway).
...
Access the [Media App](https://app.media.network) and connect your wallet. Add your resource, specifying port number & and approve the transaction.

<center><img src="/img/ipfs-resource.png" width="800"/> </center>
...
<center><img src="/img/ipfs-added.png" width="800"/> </center>
