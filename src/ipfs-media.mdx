...
:::note
You can now access any content hosted on IPFS, served by Media Network's CDN, including the previously added [`mytextfile.txt`](ipfs-setup#adding-files-to-ipfs), through your **own** IPFS Gateway: `https://3ashhppttp.medianet.work`
:::


### IPFS Example Links

[mytextfile.txt](https://3ashhppttp.medianet.work/ipfs/QmS7S76K81Qq5AeHFN5tPL8uDhY3NCCSSSBAD4xaMAq87m) <br/>
[Wikipedia](https://3ashhppttp.medianet.work/ipfs/bafybeiaysi4s6lnjev27ln5icwm6tueaw2vdykrtjkwiphwekaywqhcjze) <br/>
[Project Apollo](https://3ashhppttp.medianet.work/ipfs/QmSnuWmxptJZdLJpKRarxBMS2Ju2oANVrgbr2xWbie9b2D/frontend/frontend.html)
