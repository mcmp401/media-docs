...
To scale an existing infrastructure, developers or media platforms will have to buy MEDIA off exchanges, provide liquidity to designated pools, and stake the resulting LP MEDIA tokens. After that, they will have to authenticate with a compatible wallet to any of the available front-ends (e.g., [Media App](https://app.media.network)) and set up their resources and custom settings. 
