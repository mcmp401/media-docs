...
<Tabs
  ...
  <TabItem value="👴🏻 Legacy Domain">https://3ashhppttp.medianet.work/ipfs/QmZ3qrQqgzAxJUpYv8hURRVJf8DYtkiNrdFXFmFU88HDBy/index.html</TabItem>
  <TabItem value="🤝 HNS Domain">http://3ashhppttp.dCDN/ipfs/QmZ3qrQqgzAxJUpYv8hURRVJf8DYtkiNrdFXFmFU88HDBy/index.html</TabItem>
</Tabs>

#### Option 2: Use your own IPFS gateway

Add your IPFS node to Media Network's CDN using this [guide](ipfs-media). You'll be able access the Uniswap interface you've just built, through your **own** IPFS Gateway, without relaying on third-parties.
...
<Tabs
  ...
  <TabItem value="👴🏻 Legacy Domain">https://resourceID.medianet.work/ipfs/QmZ3qrQqgzAxJUpYv8hURRVJf8DYtkiNrdFXFmFU88HDBy/index.html</TabItem>
