...
A Content Delivery Network (CDN) is needed to serve these transcoded videos to end-users browsing a website or application leveraging Livepeer’s transcoding tech.
This section will show how to setup a broadcaster, stream to it and then serve it to end-users through Media Network's CDN.
