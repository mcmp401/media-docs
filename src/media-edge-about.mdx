...
## How does Media Edge work?

The Media Edge software allows CDN providers to create offers for their CDN services and set a maximum number of deals for each offer. They can also update the price per second at any time. This process is similar to how nodes in a blockchain network validate transactions and get rewards for their services.
