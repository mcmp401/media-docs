...
Setting up a Media Server instance and adding it to Media’s CDN through a front-end like the [Media App](app-about) will allow Media Edges to pull the content from your origin server and make it available to your end-users. By using Media Network as your CDN, you'll be able to hold millions of viewers without stressing your infrastructure and without exposing your original server IP address, eliminating the risk of a direct DDoS attack.
